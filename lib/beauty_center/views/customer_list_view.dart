...
class _CustomerListViewState extends State<CustomerListView> {
  List<ProviderServiceModel> customers = [];
  ...
  Future<void> _fetchNearby(double myLat, double myLng) async {
    final event = await FirebaseDatabase.instance.ref('BeautyCenter').once();
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              'جميع مراكز التجميل القريبة منك في 10 كم',
                              style: TextStyle(
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'ابحث/ي عن مراكز التجميل...',
                          hintStyle: TextStyle(
                          ...
                          return GestureDetector(
                            onTap: () {
                              ...
                              GoRouter.of(context).push(
                                AppRouter.kBeautyCenterDetailsView,
                                extra: h,
                              );
                            },
                            child: Container(

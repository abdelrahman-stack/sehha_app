...
class FemaleCustomerChatList extends StatefulWidget {
  const FemaleCustomerChatList({super.key});
  @override
  State<FemaleCustomerChatList> createState() => _FemaleCustomerChatListState();
}

class _FemaleCustomerChatListState extends State<FemaleCustomerChatList> {
  final _auth = FirebaseAuth.instance;
  final _chatDB = FirebaseDatabase.instance.ref('chatList');
  final _barberDB = FirebaseDatabase.instance.ref('Hairdressers');
  late String _uid;
...
class HairdresserChatListView extends StatefulWidget {
  const HairdresserChatListView({super.key});
  @override
  State<HairdresserChatListView> createState() =>
      _HairdresserChatListViewState();
}

class _HairdresserChatListViewState extends State<HairdresserChatListView> {
  final _auth = FirebaseAuth.instance;
  final _chatDB = FirebaseDatabase.instance.ref('chatList');
  final _patientDB = FirebaseDatabase.instance.ref('ClientFemales');
